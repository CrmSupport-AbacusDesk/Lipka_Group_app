...
export class HomePage {
    ...
    scanCoupon() {
        if( this.karigar_detail.status =='Pending'){
            let alert = this.alertCtrl.create({
                ...
                subTitle:"Your current profile status is  <strong class=Pending>“Pending”</strong>. You can only scan coupon  when your profile status is <strong class=Approved>“Verified”</strong>. To know more, you can call us at <a href=tel:18002122830>1800-212-2830</a> or chat with us.",
                buttons: [
                    // {
                    //     text: 'Chat With Us',
                    //     handler: () => {
            ...
            let alert = this.alertCtrl.create({
                title:'Sorry!',
                cssClass:'action-close',
                subTitle:"Your current profile status is  <strong class=Reject>“Reject”</strong>. You can only scan coupon  when your profile status is <strong class=Approved>“Verified”</strong>. To know more, you can call us at <a href=tel:18002122830>1800-212-2830</a> or chat with us.",
                buttons: [
                    // {
                    //     text: 'Chat With Us',
                    //     handler: () => {
        ...
        else if( this.karigar_detail.status =='Suspect'){
            let alert = this.alertCtrl.create({
                title:'Sorry!',
                cssClass:'action-close',
                subTitle:"Your current profile status is  <strong class=Suspect>“Suspect”</strong>. You can only scan coupon  when your profile status is <strong class=Approved>“Verified”</strong>. To know more, you can call us at <a href=tel:18002122830>1800-212-2830</a> or chat with us.",
                buttons: [
                    // {
                    //     text: 'Chat With Us',
                    //     handler: () => {
   ...
   viewProfiePic()
    ...
    goOnOffersListPage(){
        if( this.karigar_detail.status =='Pending'){
            let alert = this.alertCtrl.create({
                title:'Sorry!',
                cssClass:'action-close',
                subTitle:"Your current profile status is  <strong class=Pending>“Pending”</strong>. You can only see the offer when your profile status is <strong class=Approved>“Verified”</strong>. To know more, you can call us at <a href=tel:18002122830>1800-212-2830</a> or chat with us.",
                buttons: [
                    // {
                    //     text: 'Chat With Us',
                    //     handler: () => {
            ...
            let alert = this.alertCtrl.create({
                title:'Sorry!',
                cssClass:'action-close',
                subTitle:"Your current profile status is  <strong class=Reject>“Reject”</strong>. You can only see the offer  when your profile status is <strong class=Approved>“Verified”</strong>. To know more, you can call us at <a href=tel:18002122830>1800-212-2830</a> or chat with us.",
                buttons: [
                    // {
                    //     text: 'Chat With Us',
                    //     handler: () => {
            ...
            let alert = this.alertCtrl.create({
                title:'Sorry!',
                cssClass:'action-close',
                subTitle:"Your current profile status is  <strong class=Suspect>“Suspect”</strong>. You can only see the offer  when your profile status is <strong class=Approved>“Verified”</strong>. To know more, you can call us at <a href=tel:18002122830>1800-212-2830</a> or chat with us.",
                buttons: [
                    // {
                    //     text: 'Chat With Us',
                    //     handler: () => {
    ...
    goOnPointeListPage(){
        if( this.karigar_detail.status =='Pending'){
            let alert = this.alertCtrl.create({
                title:'Sorry!',
                cssClass:'action-close',
                subTitle:"Your current profile status is  <strong class=Pending>“Pending”</strong>. You can only see the scan history when your profile status is <strong class=Approved>“Verified”</strong>. To know more, you can call us at <a href=tel:18002122830>1800-212-2830</a> or chat with us.",
                buttons: [
                    // {
                    //     text: 'Chat With Us',
                    //     handler: () => {
            ...
            let alert = this.alertCtrl.create({
                title:'Sorry!',
                cssClass:'action-close',
                subTitle:"Your current profile status is  <strong class=Reject>“Reject”</strong>. You can only see the scan history  when your profile status is <strong class=Approved>“Verified”</strong>. To know more, you can call us at <a href=tel:18002122830>1800-212-2830</a> or chat with us.",
                buttons: [
                    // {
                    //     text: 'Chat With Us',
                    //     handler: () => {
    ...
    gotoHistory()
    {
        if( this.karigar_detail.status =='Pending'){
            let alert = this.alertCtrl.create({
                title:'Sorry!',
                cssClass:'action-close',
                subTitle:"Your current profile status is  <strong class=Pending>“Pending”</strong>. You can only see the  Gift Tracker when your profile status is <strong class=Approved>“Verified”</strong>. To know more, you can call us at <a href=tel:18002122830>1800-212-2830</a> or chat with us.",
                buttons: [
                    // {
                    //     text: 'Chat With Us',
                    //     handler: () => {
            ...
            let alert = this.alertCtrl.create({
                title:'Sorry!',
                cssClass:'action-close',
                subTitle:"Your current profile status is  <strong class=Reject>“Reject”</strong>. You can only see the  Gift Tracker  when your profile status is <strong class=Approved>“Verified”</strong>. To know more, you can call us at <a href=tel:18002122830>1800-212-2830</a> or chat with us.",
                buttons: [
                    // {
                    //     text: 'Chat With Us',
                    //     handler: () => {
            ...
            let alert = this.alertCtrl.create({
                title:'Sorry!',
                cssClass:'action-close',
                subTitle:"Your current profile status is  <strong class=Suspect>“Suspect”</strong>. You can only see the  Gift Tracker  when your profile status is <strong class=Approved>“Verified”</strong>. To know more, you can call us at <a href=tel:18002122830>1800-212-2830</a> or chat with us.",
                buttons: [
                    // {
                    //     text: 'Chat With Us',
                    //     handler: () => {
    ...
    goOnGiftGallary()
    {
        if( this.karigar_detail.status =='Pending'){
            let alert = this.alertCtrl.create({
                title:'Sorry!',
                cssClass:'action-close',
                subTitle:"Your current profile status is  <strong class=Pending>“Pending”</strong>. You can only see the gift gallery when your profile status is <strong class=Approved>“Verified”</strong>. To know more, you can call us at <a href=tel:18002122830>1800-212-2830</a> or chat with us.",
                buttons: [
                    // {
                    //     text: 'Chat With Us',
                    //     handler: () => {
            ...
            let alert = this.alertCtrl.create({
                title:'Sorry!',
                cssClass:'action-close',
                subTitle:"Your current profile status is  <strong class=Reject>“Reject”</strong>. You can only see the gift gallery  when your profile status is <strong class=Approved>“Verified”</strong>. To know more, you can call us at <a href=tel:18002122830>1800-212-2830</a> or chat with us.",
                buttons: [
                    // {
                    //     text: 'Chat With Us',
                    //     handler: () => {
            ...
            let alert = this.alertCtrl.create({
                title:'Sorry!',
                cssClass:'action-close',
                subTitle:"Your current profile status is  <strong class=Suspect>“Suspect”</strong>. You can only see the gift gallery  when your profile status is <strong class=Approved>“Verified”</strong>. To know more, you can call us at <a href=tel:18002122830>1800-212-2830</a> or chat with us.",
                buttons: [
                    // {
                    //     text: 'Chat With Us',
                    //     handler: () => {
    ...
    goRedeemType(){
        ...
        if( this.karigar_detail.status =='Pending'){
            let alert = this.alertCtrl.create({
                title:'Sorry!',
                cssClass:'action-close',
                subTitle:"Your current profile status is  <strong class=Pending>“Pending”</strong>. You can only redeem your points when your profile status is <strong class=Approved>“Verified”</strong>. To know more, you can call us at <a href=tel:18002122830>1800-212-2830</a> or chat with us.",
                buttons: [
                    // {
                    //     text: 'Chat With Us',
                    //     handler: () => {
            ...
            let alert = this.alertCtrl.create({
                title:'Sorry!',
                cssClass:'action-close',
                subTitle:"Your current profile status is  <strong class=Reject>“Reject”</strong>. You can only redeem your points  when your profile status is <strong class=Approved>“Verified”</strong>. To know more, you can call us at <a href=tel:18002122830>1800-212-2830</a> or chat with us.",
                buttons: [
                    // {
                    //     text: 'Chat With Us',
                    //     handler: () => {
            ...
            let alert = this.alertCtrl.create({
                title:'Sorry!',
                cssClass:'action-close',
                subTitle:"Your current profile status is  <strong class=Suspect>“Suspect”</strong>. You can only redeem your points  when your profile status is <strong class=Approved>“Verified”</strong>. To know more, you can call us at <a href=tel:18002122830>1800-212-2830</a> or chat with us.",
                buttons: [
                    // {
                    //     text: 'Chat With Us',
                    //     handler: () => {
    ...
    share()
    {
        ...
        let image = "";
        let app_url = "https://play.google.com/store/apps/details?id=com.lipkagroup.app";
        
        this.socialSharing.share("Hey there join me (" + this.karigar_detail.full_name + "-" + this.karigar_detail.mobile_no + ") on  Lipka Plumber, a bath app. Enter my code *" + this.karigar_detail.referral_code + "* to earn points back in your wallet!", "Karigar Reffral", image, app_url)
        .then(resp=>{
            console.log(resp);
